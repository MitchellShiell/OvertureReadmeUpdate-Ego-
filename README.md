...
&emsp; - [summary steps linked here](https://www.overture.bio/documentation/ego/installation/prereq/#google). 
&emsp; - Use the following redirect URI: ```http://localhost:8081/oauth/code/google```
